    <div class="container"  data-aos="flip-left" data-aos-duration="1000">
          <div class="row">
            <div class="col-md-6 ml-auto mr-auto">
              ...
              <div class="nav-align-center">
                <ul class="nav nav-pills nav-pills-danger" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#Photography" role="tablist" data-aos="flip-left" data-aos-duration="1000" rel="tooltip" title="Curso Udemy">
            ...
            <div class="tab-pane" id="graphic-design" role="tabpanel">
              <div class="ml-auto mr-auto">
                <div class="row">
                  <div class="col-md-6">
                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                      <a href="#SololearnHtml5">
                        <figure class="cc-effect">
                          <img src="images/graphic-design-1.jpg" alt="Image" />
                          <figcaption>
                            <div class="h4">HTML5</div>
                            <p><i class=" fa fa-code fa-3x" ></i></p>
                          </figcaption>
                        </figure>
                      </a>
                    </div>
                      ...
                      <a href="#SololearnSQL">
                        <figure class="cc-effect">
                          ...
                          <figcaption>
                            ...
                            <p><i class=" fa fa-database fa-3x" ></i></p>
                          </figcaption>
                        </figure>
                      </a>
                    </div>
